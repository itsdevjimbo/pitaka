...
public record GoalResource(int Id, string Name, decimal TargetAmount, DateOnly? TargetDate, GoalStatus Status)
{
    public static GoalResource FromModel(Goal goal) =>
        new(goal.Id, goal.Name, goal.TargetAmount, goal.TargetDate, goal.Status);
