...
{
    public static WebApplicationBuilder AddRecurringTransactionGeneration(
        this WebApplicationBuilder builder
    )
    {
        builder
            .Services.AddOptions<RecurringTransactionGenerationOption>()
            .Bind(
                builder.Configuration.GetSection(RecurringTransactionGenerationOption.SectionName)
            )
