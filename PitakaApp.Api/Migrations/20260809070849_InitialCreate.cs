...
namespace PitakaApp.Api.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
                ...
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        type = table
                            ...
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        initial_balance = table.Column<decimal>(
                            type: "decimal(14,2)",
                            nullable: false
                        ),
                        current_balance = table.Column<decimal>(
                            type: "decimal(14,2)",
                            nullable: false
                        ),
                ...
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        name = table
                            .Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        target_amount = table.Column<decimal>(
                            type: "decimal(14,2)",
                            nullable: false
                        ),
                        current_amount = table.Column<decimal>(
                            type: "decimal(14,2)",
                            nullable: false
                        ),
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        amount_limit = table.Column<decimal>(
                            type: "decimal(14,2)",
                            nullable: false
                        ),
                        period = table
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        amount = table.Column<decimal>(type: "decimal(14,2)", nullable: false),
                        contribution_date = table.Column<DateTime>(
                            type: "datetime(6)",
                            nullable: false
                        ),
                        note = table
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    constraints: table =>
                    {
                        table.PrimaryKey(
                            "pk_tag_transaction",
                            x => new { x.tags_id, x.transactions_id }
                        );
                        table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(name: "ix_tags_user_id", table: "tags", column: "user_id");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "goal_contributions");

            migrationBuilder.DropTable(name: "tag_transaction");
