...
namespace PitakaApp.Api.Migrations
{
    ...
    [Migration("20260902095819_RestrictCategoryDeleteWhenInUse")]
    partial class RestrictCategoryDeleteWhenInUse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PitakaApp.Api.Models.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PitakaApp.Api.Models.Category", b =>
                {
                    b.HasOne("PitakaApp.Api.Models.Category", "Parent")
                        .WithMany("Children")
