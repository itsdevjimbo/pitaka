...
{
    private readonly RequestEmailChange _requestEmailChange = requestEmailChange;
    private readonly RedeemEmailChange _redeemEmailChange = redeemEmailChange;
    ...
    public async Task<IActionResult> ChangePassword(ChangePasswordRequest request)
    {
        ...
        {
            ChangePasswordOutcome.Succeeded => NoContent(),
            ...
            ChangePasswordOutcome.IncorrectPassword => Problem(
            ...
            _ => throw new ArgumentOutOfRangeException(
                nameof(outcome),
                outcome,
                "Unhandled change-password outcome."
            ),
        };
    }
    ...
    public async Task<IActionResult> RequestEmailChange(RequestEmailChangeRequest request)
    {
        ...
        return outcome switch
        {
            RequestEmailChangeOutcome.Succeeded => NoContent(),
            ...
            RequestEmailChangeOutcome.EmailTaken => Problem(
            ...
            RequestEmailChangeOutcome.UnchangedAddress => Problem(
            ...
            RequestEmailChangeOutcome.IncorrectPassword => Problem(
                detail: "Your current password is incorrect.",
                statusCode: StatusCodes.Status401Unauthorized
            ),
            _ => throw new ArgumentOutOfRangeException(
                nameof(outcome),
                outcome,
                "Unhandled email-change outcome."
            ),
        };
    }
    ...
    public async Task<IActionResult> ConfirmEmailChange(RedeemEmailChangeRequest request)
    {
        ...
        return outcome switch
        {
            RedeemEmailChangeOutcome.Succeeded => NoContent(),
            ...
            RedeemEmailChangeOutcome.EmailTaken => Problem(
            ...
            RedeemEmailChangeOutcome.Invalid => Problem(
            ...
            _ => throw new ArgumentOutOfRangeException(
                nameof(outcome),
                outcome,
                "Unhandled email-change confirm outcome."
            ),
        };
    }
